...
<div class="box">
 ...
 <form action="profile-image.php" method="post" enctype="multipart/form-data">
  ...
  <label for="filex" style="color: white; position:fixed; margin-left: 120px;font-size: 20px;margin-top: 50px" class="fa fa-plus-circle"></label>
...
<br>
<br>
  <button type="submit" class="fa fa-upload" name="upload"> เปลี่ยนรูปภาพชั่วคราว</button>
   </form>
   <br>
   <br>
  <div style="
...
<label>
  ...
  " class="fa fa-eye-slash" type="submit" name="get"> ดูรหัสผ่าน</button>
   ...
   <br>
  <a  class="fa fa-key"> เปลี่ยนรหัสผ่าน (ยังไม่เปิดใช้งาน) </a>
  <br>
